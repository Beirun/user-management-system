        ...
        <div class="w-full h-full flex flex-col  items-center gap-10 mt-10">
            ...
            <div class="w-1/4 flex flex-col gap-5 justify-between">
                <div class="w-full flex ">
                    ...
                    <p>{{account?.title}}. {{ account?.firstName }} {{ account?.lastName }}</p>
                </div>
                <div class="w-full flex ">
                    ...
                    <DialogContent class="sm:max-w-[425px]">
                        ...
                        <div class="grid gap-4 py-4">
                            <div class="grid grid-cols-4 items-center gap-4">
                                ...
                                <input id="title" type="text" class="col-span-3 h-10 border mt-1 rounded px-3 py-2 bg-[#F5F5F5] border-[#666E99] text-black " readonly :value="account?.title"/>
                            </div>
                            <div class="grid grid-cols-4 items-center gap-4">
                                <label for="firstname" class="text-right">Firstname</label>
                                <input id="firstname" type="text" class="col-span-3 h-10 border mt-1 rounded px-3 py-2 bg-[#F5F5F5] border-[#666E99] text-black" :value="account?.firstName"/>
                            </div>
                            <div class="grid grid-cols-4 items-center gap-4">
                                <label for="lastname" class="text-right">Lastname</label>
                                <input id="lastname" type="text" class="col-span-3 h-10 border mt-1 rounded px-3 py-2 bg-[#F5F5F5] border-[#666E99] text-black" :value="account?.lastName"/>
                            </div>
                            <div class="grid grid-cols-4 items-center gap-4">
                                <label for="email" class="text-right">Email</label>
                                <input id="email" type="email" class="col-span-3 h-10 border mt-1 rounded px-3 py-2 bg-[#F5F5F5] border-[#666E99] text-black" :value="account?.email" />
                            </div>
                            <!-- <div class="grid grid-cols-4 items-center gap-4">
                                <label for="password" class="text-right">Password</label>
                                <input id="password" type="password" class="col-span-3 h-10 border mt-1 rounded px-3 py-2 bg-[#F5F5F5] border-[#666E99] text-black"  :value="account?."/>
                            </div> -->
                        </div>
                        <DialogFooter>
